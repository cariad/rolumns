...
This code is identical to :doc:`the Flat Table example <flat>` except for the *positions* column set created by calling :func:`Columns.add_group`. The path passed in describes the path to the iterable collection.
